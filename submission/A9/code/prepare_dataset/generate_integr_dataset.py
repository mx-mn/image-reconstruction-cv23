...
def AOS_integrator(set_folder, aos, output_dir, thermal_imgs_dir, focal_plane):
    ...
    Download_Location = output_dir   ## Enter path to the directory where you want to save the results.
    ...
    Focal_plane = -focal_plane # Focal plane is set to the ground so it is zero.
    ...
    name_focal_plane = int(-100 * Focal_plane)
    filename = f"integral_{name_focal_plane:02d}.png"
